...
哈密顿结构对于构建PAVF格式至关重要.然而,目前没有研究人员考虑过带有周期边界条件的NFSWEs \eqref{eq_SAVRRK:1}-\eqref{eq_SAVRRK:3} 的哈密顿结构.
...
\begin{proof}
	令 $\phi(\boldsymbol{x})$ 为带有周期边界条件的任意函数.由于分数阶拉普拉斯是线性算子，根据变分导数的定义,有
\begin{equation}
\begin{aligned}
