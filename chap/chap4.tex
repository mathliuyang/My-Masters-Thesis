...
\includegraphics[width=0.35\textwidth]{./figure/exp2_s5.eps}
%\centerline{($b$) Spatial accuracy with $\tau = 10^{-3}.$}
}\subfigure[$N=128$]{ \centering
\includegraphics[width=0.35\textwidth]{./figure/exp2_t5.eps}
...
\begin{figure}[H]
	...
	\includegraphics[width=0.4\textwidth]{./figure/exp2_H3.eps}
	%\centerline{($a$) $\alpha=1.3$}
	}\subfigure[$\alpha=1.6$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_H6.eps}
	%\centerline{($b$) $\alpha=1.6$}
	}\\
	\subfigure[$\alpha=1.9$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_H9.eps}
	%\centerline{($d$) $\alpha=2.0$}
	}\subfigure[$\alpha=2.0$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_H2.eps}
	%\centerline{($d$) $\alpha=2.0$}
...
\begin{figure}[H]
	\begin{center}
	 \subfigure[$\alpha=1.3$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_M3.eps}
	%\centerline{($a$) $\alpha=1.3$}
	}\subfigure[$\alpha=1.6$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_M6.eps}
	%\centerline{($b$) $\alpha=1.6$}
	}\\
	 \subfigure[$\alpha=1.9$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_M9.eps}
	%\centerline{($c$) $\alpha=1.9$}
	}\subfigure[$\alpha=2.0$]{ \centering
	\includegraphics[width=0.4\textwidth]{./figure/exp2_M2.eps}
	%\centerline{($d$) $\alpha=2.0$}
...
\begin{center}
 \subfigure[$\alpha=1.3$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RM3.eps}
%\centerline{($a$) $\alpha=1.3$}
}\subfigure[$\alpha=1.6$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RM6.eps}
%\centerline{($b$) $\alpha=1.6$}
}\subfigure[$\alpha=1.9$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RM9.eps}
%\centerline{($c$) $\alpha=1.9$}
...
\begin{center}
 \subfigure[$\alpha=1.3$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RH3.eps}
%\centerline{($a$) $\alpha=1.3$}
}\subfigure[$\alpha=1.6$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RH6.eps}
%\centerline{($b$) $\alpha=1.6$}
} \subfigure[$\alpha=1.9$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp2_RH9.eps}
%\centerline{($c$) $\alpha=1.9$}
...
\begin{center}
\subfigure[$\tau=1/1000$]{ \centering
\includegraphics[width=0.35\textwidth]{./figure/exp4_s5.eps}
%\centerline{($b$) Spatial accuracy with $\tau = 10^{-3}.$}
}\subfigure[$N=16$]{ \centering
\includegraphics[width=0.35\textwidth]{./figure/exp4_t5.eps}
%\centerline{($a$) Temporal accuracy with $N=128.$}
...
\begin{center}
\subfigure[$\tau=1/1000$]{ \centering
\includegraphics[width=0.35\textwidth]{./figure/exp4_s2.eps}
%\centerline{($b$) Spatial accuracy with $\tau = 10^{-3}.$}
}\subfigure[$N=16$]{ \centering
\includegraphics[width=0.35\textwidth]{./figure/exp4_t2.eps}
%\centerline{($a$) Temporal accuracy with $N=128.$}
...
\begin{figure}[H]
	\begin{center}
	 \subfigure[$\alpha=1.3$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_M3.eps}
	%\centerline{($a$) $\alpha=1.3$}
	}\subfigure[$\alpha=1.6$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_M6.eps}
	%\centerline{($b$) $\alpha=1.6$}
	}\\
	 \subfigure[$\alpha=1.9$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_M9.eps}
	%\centerline{($c$) $\alpha=1.9$}
	}\subfigure[$\alpha=2.0$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_M2.eps}
	%\centerline{($d$) $\alpha=2.0$}
...
\begin{figure}[H]
	\begin{center}
	\subfigure[$\alpha=1.3$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_H3.eps}
	%\centerline{($a$) $\alpha=1.3$}
	}\subfigure[$\alpha=1.6$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_H6.eps}
	%\centerline{($b$) $\alpha=1.6$}
	}\\
	\subfigure[$\alpha=1.9$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_H9.eps}
	%\centerline{($d$) $\alpha=2.0$}
	}\subfigure[$\alpha=2.0$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_H2.eps}
	%\centerline{($d$) $\alpha=2.0$}
...
\begin{center}
 \subfigure[$\alpha=1.3$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RM3.eps}
%\centerline{($a$) $\alpha=1.3$}
}\subfigure[$\alpha=1.6$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RM6.eps}
%\centerline{($b$) $\alpha=1.6$}
}\subfigure[$\alpha=1.9$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RM9.eps}
%\centerline{($c$) $\alpha=1.9$}
...
\begin{center}
 \subfigure[$\alpha=1.3$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RH3.eps}
%\centerline{($a$) $\alpha=1.3$}
}\subfigure[$\alpha=1.6$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RH6.eps}
%\centerline{($b$) $\alpha=1.6$}
} \subfigure[$\alpha=1.9$]{ \centering
\includegraphics[width=0.3\textwidth]{./figure/exp4_RH9.eps}
%\centerline{($c$) $\alpha=1.9$}
...
$t$   &FAVF   &FPAVF   &FPAVF-C   &FPAVF-P\\
  ...
  \begin{figure}[H]
	...
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p0.eps}
	}\subfigure[$t=1s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p1.eps}
	} \subfigure[$t=5s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p5.eps}
	}\\
	\subfigure[$t=10s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p10.eps}
	}\subfigure[$t=50s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p50.eps}
	} \subfigure[$t=100s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour3_p100.eps}
...
\begin{figure}[H]
	\begin{center}
	 \subfigure[$t=0s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p0.eps}
	}\subfigure[$t=1s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p1.eps}
	} \subfigure[$t=5s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p5.eps}
	}\\
	\subfigure[$t=10s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p10.eps}
	}\subfigure[$t=50s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p50.eps}
	} \subfigure[$t=100s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour6_p100.eps}
...
\begin{figure}[H]
	\begin{center}
	 \subfigure[$t=0s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p0.eps}
	}\subfigure[$t=1s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p1.eps}
	} \subfigure[$t=5s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p5.eps}
	}\\
	\subfigure[$t=10s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p10.eps}
	}\subfigure[$t=50s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p50.eps}
	} \subfigure[$t=100s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour99_p100.eps}
...
\begin{figure}[H]
	\begin{center}
	 \subfigure[$t=0s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p0.eps}
	}\subfigure[$t=1s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p1.eps}
	} \subfigure[$t=5s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p5.eps}
	}\\
	\subfigure[$t=10s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p10.eps}
	}\subfigure[$t=50s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p50.eps}
	} \subfigure[$t=100s$]{ \centering
	\includegraphics[width=0.3\textwidth]{./figure/exp4_contour2_p100.eps}
