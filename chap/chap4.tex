...
为了得到NFSWEs \eqref{eq_SAVRRK:1}-\eqref{eq_SAVRRK:2} 的Hamilton形式，我们引入了两个重要的引理。
...
考虑Hamilton系统\eqref{eq_PAVF:60}，并应用PAVF方法，我们可以得到求解NFSWEs \eqref{eq_SAVRRK:1}-\eqref{eq_SAVRRK:2} 的完全离散方案，如下所示：
\begin{align}
