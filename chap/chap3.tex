...
详见 \citep{guoExistenceGlobalSmooth2008} 引理3.1的证明 . 
...
参见 \citep{guoExistenceGlobalSmooth2008} 引理3.2的证明 . 
...
实际上 , 在\eqref{eq_SAVRRK:4-6}中定义的$\gamma_m$的值在$\tau\rightarrow 0$时接近于$1$ , 这将在\ref{Section_SAVRRK: 5-1}节中进一步讨论 . 
...
\begin{proof}
类似于\citep{liImplicitexplicitRelaxationRungeKutta2022}中引理3 . 1的证明 , 
考虑初值问题
\begin{equation}
\left\{\begin{array}{l}
...
参考\citep{ranochaGeneralRelaxationMethods2020}中引理2.7的证明思路 , 得到了以下结果 . 
...
不失一般性 , 在计算中使用了以下的显式RK方法\cite{shuEfficientImplementationEssentially1988}.
\begin{itemize}
...
\begin{example}\label{exp_SAVRRK:1} 
	...
	SAV-RRK(IDT)(2 , 2) 和 SAV-RRK(IDT)(4 , 4) 展示出了比定理\ref{thm_SAVRRK:5_4}中预期阶数更高的收敛阶 , 
	而 SAV-RRK(IDT)(3 , 3) 并没有出现升阶现象. 如图 \ref{fig_SAVRRK:1} 所示 , 这种不同的行为可能归因于偶数阶SAV-RRK方法的 $\max\limits _m\left|\gamma_m-1\right|$ 
	相较于理论分析上升了一个阶.
...
\multicolumn{2}{l}{} & \multicolumn{2}{l}{0.05} & 2.3572E-08 &       & 3.9994  &       & 2.3939E-08 &       & 4.0221  &       & 4.4585E-08 &       & \textbf{3.9878}  \\
\multicolumn{2}{l}{} & \multicolumn{2}{l}{0.025} & 1.4730E-09 &       & 4.0003  &       & 1.4843E-09 &       & 4.0115  &       & 2.8080E-09 &       & \textbf{3.9889}  \\
\multicolumn{2}{l}{} & \multicolumn{2}{l}{0.0125} & 9.2041E-11 &       & 4.0003  &       & 9.2397E-11 &       & 4.0058  &       & 1.7743E-10 &       & \textbf{3.9842}  \\
\multicolumn{2}{l}{} & \multicolumn{2}{l}{0.00625} & 5.7518E-12 &       & 4.0002  &       & 5.7630E-12 &       & 4.0029  &       & 1.1309E-11 &       & \textbf{3.9718}  \\
\bottomrule
\end{tabular}%
\label{tab_SAVRRK:6-1}%
\end{table}%
此外 , 为估计松弛因子 $\gamma_m$ , 在图 \ref{fig_SAVRRK:1} 中展示了在不同时间步长 $\tau$下的 $\max\limits _m\left|\gamma_m-1\right|$ 和 $\max\limits _m\left|S_m(1)\right|$的计算结果.
