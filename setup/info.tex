...
%论文中文题目
\newcommand{\thesicnutitlec}{二维分数阶非线性 Schr{\"o}dinger 波方程的数值方法与守恒性质研究}
%论文中文分行题目
\newcommand{\thesicnutitleca}{二维分数阶非线性 Schr{\"o}dinger 波方程的}
...
%论文提交日期
\newcommand{\thesicnudateofsubmit}{2023年5月20日\ \ \ \ \ \ \ \ }
\newcommand{\SiCNUDateOfSubmit}[1]{\renewcommand{\thesicnudateofsubmit}{#1}}
%论文答辩日期
\newcommand{\thesicnudateofdefence}{2023年5月20日\ \ \ \ \ \ \ \ }
