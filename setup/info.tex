...
%论文中文题目
\newcommand{\thesicnutitlec}{非线性分数阶薛定谔波动方程的保结构算法}
%论文中文分行题目
\newcommand{\thesicnutitleca}{非线性薛定谔波动方程}
\newcommand{\thesicnutitlecb}{的保结构算法}
...
%论文英文题目
\newcommand{\thesicnutitlee}{Structure-Preserving Algorithms for the Nonlinear Fractional Schr{\"o}dinger Wave Equation}
%论文英文分行题目
\newcommand{\thesicnutitleea}{Structure-Preserving Algorithms for the Nonlinear}
\newcommand{\thesicnutitleeb}{Fractional Schr{\"o}dinger Wave Equation}
