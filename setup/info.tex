...
%专业名称中文
\newcommand{\thesicnumajorc}{计算数学}
\newcommand{\SiCNUMajorC}[1]{\renewcommand{\thesicnumajorc}{#1}}
%专业名称英文
\newcommand{\thesicnumajore}{Computational Mathematics}
...
%论文中文分行题目
\newcommand{\thesicnutitleca}{非线性分数阶薛定谔波动方程的}
\newcommand{\thesicnutitlecb}{两类保结构数值方法}
...
%论文英文分行题目
\newcommand{\thesicnutitleea}{Two Classes of Structure-Preserving Numerical}
\newcommand{\thesicnutitleeb}{Methods for the Nonlinear Fractional }
\newcommand{\thesicnutitleec}{Schr{\"o}dinger Wave Equations}
...
%论文提交日期
\newcommand{\thesicnudateofsubmit}{2024年3月20日\ \ \ \ \ \ \ \ }
