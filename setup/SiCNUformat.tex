...
\centerline{{\heiti \thesicnumajorc 专业}{\heiti }}
\centerline{}
\centerline{{\heiti 研究生:}~~{\kaishu \thesicnuauthorc}\qquad{\heiti 指导教师:}~~{\kaishu \thesicnusupervisorc~#1}}
\list{}{
\itemindent=2em
\listparindent=2em
\itemsep=0pt
...
\centerline{{\bf \thesicnumajore \ Major}}
\centerline{}
